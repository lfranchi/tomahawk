...
IndentPrivate::IndentPrivate(QObject* parent, const QString & a)
    : QObject(parent)
{
    const QString area = "tomahawk";
    setObjectName( area + QLatin1String("DavrosIndentObject"));
    data.setLocalData(0);
}


IndentPrivate* IndentPrivate::instance(const QString & a)
{
    const QString area = "tomahawk";
    IndentPrivate *obj;
...
ContextPrivate::ContextPrivate(QObject* parent, const QString & a)
    : QObject(parent)
...
ContextPrivate* ContextPrivate::instance(const QString & a)
{
    const QString area = "tomahawk";
    ContextPrivate *obj;
